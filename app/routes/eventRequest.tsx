...
export default function EventRequest() {
  ...
  return (
    <div>
      <Header />
      <div className="flex justify-center items-center h-[25rem] md:h-[35rem] max-w-screen-2xl mx-auto bg-primary bg-cover bg-bottom">
        <div className="p-10">
      ...
      <section className="bg-white">
        <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
          <p className="mb-8 lg:mb-16 font-light text-center text-gray-500 sm:text-xl">
            Want Latinos en Pizza catering at your next event? Let us know!
          </p>
          <form
            id="eventRequest"
            name="eventRequest"
          ...
          >
            ...
            {actionData && (
              <div
                ...
                role="alert"
              >
                <span className="font-medium">Message Submitted!</span> Our team
