  ...
  return (
    <>
      ...
      <main className="max-w-screen-2xl mx-auto pb-8">
        <div className="flex justify-center md:items-center h-[25rem] md:h-[35rem] max-w-screen-2xl mx-auto bg-primary bg-cover bg-bottom">
          <div className="p-10">
            <h1 className="uppercase text-4xl md:text-6xl text-center text-white  mt-6 md:mt-0">
              Meet Latinos en Pizza
            </h1>
          </div>
        </div>
        <div>
